# Step 6 — `agent-notify2 jump`: which agent you meant, and what zellij is asked.
#
...
const TMP = ($nu.temp-dir | path join "agent-notify2-tests-jump")
const PROBE = "agent-notify2-tests-jump"
